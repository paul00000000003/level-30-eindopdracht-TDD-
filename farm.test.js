...
describe("get_revenue_for_crop", () => {
    ...
    test("Get revenue for crop", () => expect(get_revenue_for_crop(corn, environmental_factor)).toBe(110.25));
});
...
describe("get_profit_for_crop", () => {
    ...
    const environmental_factor = { sun: "low", wind: "medium", underground: "clay" };
    test("get profit for crop", () => expect(get_profit_for_crop(corn, environmental_factor)).toBe(10.25))
});
...
describe("get_total_profit", () => {
    ...
    const environmental_factor = { sun: "low", wind: "medium", underground: "clay" };
    test("get total profit", () => expect(get_total_profit(input, environmental_factor)).toBe(102.50))
});
...
describe("get_yield_for_plant", () => {
    ...
    test("Get yield for plant with environment factors", () => {
        expect(get_yield_for_plant(corn, environmental_factor)).toBe(0.735)
    })
});
